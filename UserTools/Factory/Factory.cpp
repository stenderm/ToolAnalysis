...
//if (tool=="DQMonitoringPMT") ret=new DQMonitoringPMT;
if (tool=="TopoRecoConverter") ret=new TopoRecoConverter;
if (tool=="MonitorDataQuality") ret=new MonitorDataQuality;
return ret;
}
